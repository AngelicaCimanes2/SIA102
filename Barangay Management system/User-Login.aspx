<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User-Login.aspx.cs" Inherits="Barangay_Management_system.User_Login" %>
       ...
       <div class="wrapper">
           <div class="form">
            ...
            <div class="forgotpass">
                <asp:Label ID="lblerrorr" runat="server" Text="" Visible="false"></asp:Label>
                <a href="forgotpassword.aspx">forgot password?</a>
                <a href="User-Sign-in.aspx">Dont have account?</a>
            </div>
